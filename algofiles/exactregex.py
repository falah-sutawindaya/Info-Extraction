...
def dateregex1(e):
        ...
        tanggalbulan = re.findall(r"((Senin|Selasa|Rabu|Kamis|Jumat|Sabtu|Minggu)?\,?\s?[\d]{1,2}\s(Januari|Februari|Maret|April|Apr|Mei|Juni|Juli|Augustus|September|Oktober|November|Desember)(\s\d{4})?(\s[\d]{1,2}[.:][\d]{1,2}\s?W?I?[BT]?A?)?)", e)
        return tanggalbulan
